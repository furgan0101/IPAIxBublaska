...
export const MOCK_REPORTS: CrisisReport[] = [
  ...
  },
  {
    ...
    aiSummary:
      "A citizen report with photo shows a fallen tree partially blocking a residential street in Heilbronn-Ost. The photo metadata is consistent with the report, but it is a single source and no second confirmation has arrived yet. Held for human review.",
    locationConfidence: 69,
    reasonForDecision:
      "Human review required: single plausible source with consistent metadata; awaiting cross-source confirmation before routing to municipal services.",
    breakdown: {
      sourceReliability: 58,
      locationMatch: 69,
      mediaSupport: 66,
      crossSourceConfirmation: 38,
    },
    evidenceLinks: [
      {
        sourceType: "Citizen Report",
        title: "Warn-app photo: tree across parking lane, Karlstraße",
        time: minutesAgo(19),
        credibility: "medium",
        href: "#",
      },
      {
        sourceType: "Forum",
        title: "hn-nachbarn thread: loud crack heard around 21:10",
        time: minutesAgo(16),
        credibility: "medium",
        href: "#",
      },
    ...
    signalSnippet:
      "Baum liegt quer über der Karlstraße, Parkspur blockiert, niemand verletzt soweit …",
    signalSource: "Warn-app · Citizen Report",
  },
];
