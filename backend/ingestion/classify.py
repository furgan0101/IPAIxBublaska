...
_RULES_SPEC: tuple[tuple[str, str], ...] = (
    ...
    ("chemical_accident", r"chemieunfall|chemiest[öo]rfall|s[äa]ureaustritt|ammoniak|chlorgas|bei[ßs]ender geruch|abc-?zug|atemwegsreiz|chemical (?:spill|accident)"),
