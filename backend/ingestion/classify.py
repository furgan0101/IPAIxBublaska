...
_RULES_SPEC: tuple[tuple[str, str], ...] = (
    ...
    ("pandemic", r"pandemie|epidemie|infektionswelle|virus.?ausbruch|quarant[äa]ne|pandemic|epidemic"),
    ("chemical_accident", r"chemieunfall|chemiest[öo]rfall|s[äa]ureaustritt|ammoniak|chlorgas|bei[ßs]ender geruch|atemwegsreiz|chemical (?:spill|accident)"),
    ...
    ("power_outage", r"stromausfall|\bblackout\b|ohne strom|stromnetz\w* ausgefallen|trafo.?st[öo]rung|power (?:outage|cut)"),
